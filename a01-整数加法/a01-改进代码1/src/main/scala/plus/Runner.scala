...
object Runner extends App {
  ...
  type HList7 = Appendable[
    Appendable[Appendable[Appendable[Appendable[Appendable[Appendable[Zero, Item1], Item2], Item3], Item4], Item5], Item6],
    Item7
  ]
  ...
  println((new Item5: BB#Tail#Tail#Tail#Tail#Tail#Tail#Tail#Tail#Tail#Tail#Tail#Tail#Tail#Head).item5ToString) // I'm Item5.
  println(bb)
