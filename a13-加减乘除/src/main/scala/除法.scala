...
class 被除数零 extends 被除数 {
  ...
  override type 除以[I <: 除数]                          = 商零
  override type 消去[I1 <: 除数, I3 <: 自然数对, 原始除数 <: 除数] = I1#操作商[商零, I3]
...
class 被除数正数[Tail <: 被除数, Head] extends 被除数 {
  ...
  override type 除以[I <: 除数]                          = I#被消去[Tail, Head, I#消去1[Tail, Head], I]
  override type 消去[I1 <: 除数, I3 <: 自然数对, 原始除数 <: 除数] = I1#被消去[Tail, Head, I3, 原始除数]
  override type 被消去1[I1 <: 除数, I2, I3]               = 自然数对正数[I1#消去1[Tail, Head], I2, I3]
}

class 除数零 extends 除数 {
  override type Next[T]                                    = 除数正数[除数零, T]
  override type 被消去[I1 <: 被除数, I2, I3 <: 自然数对, 原始除数 <: 除数] = 商正数[被除数正数[I1, I2]#除以[原始除数], I3]
...
class 除数正数[Tail <: 除数, Head] extends 除数 {
  ...
  override type 被消去[I1 <: 被除数, I2, I3 <: 自然数对, 原始除数 <: 除数] = I1#消去[Tail, I3, 原始除数]
