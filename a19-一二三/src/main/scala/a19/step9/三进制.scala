...
trait 三进制后继 {
  ...
  type 二级满位发生退位[不退位 <: 三进制后继, 退位 <: 三进制后继] <: 三进制后继
}
...
class 底层_1[T0, T1] extends 三进制后继 {
  ...
  override type 二级满位发生退位[不退位 <: 三进制后继, 退位 <: 三进制后继] = 退位
}
...
class 底层_2[T0, T1, T2] extends 三进制后继 {
  ...
  override type Next[T]                             = 中层准备退位_0[T0, T1, T2, 底层_0[T]]
  override type 后继上一级操作[II <: 三进制后继, Need <: 三进制后继] = II
  override type Pred                                = 底层_1[T0, T1]
  override type 前驱上一级操作[不退位 <: 三进制后继, 退位 <: 三进制后继]  = 不退位
  override type 二级满位发生退位[不退位 <: 三进制后继, 退位 <: 三进制后继] = 不退位
}
...
class 中层_0[T0, T1, T2, II0 <: 三进制后继] extends 三进制后继 {
  ...
  override type 后继上一级操作[II <: 三进制后继, Need <: 三进制后继] = II
  override type Pred                                = II0#二级满位发生退位[中层_0[T0, T1, T2, II0#Pred], 中层准备退位_0[T0, T1, T2, II0#Pred]]
...
class 中层准备进位_0[T0, T1, T2, II0 <: 三进制后继] extends 三进制后继 {
  ...
  override type Next[T]                             = 中层准备退位_1[T0, T1, T2, II0, 底层_0[T]]
  override type 后继上一级操作[II <: 三进制后继, Need <: 三进制后继] = II
  override type Pred                                = II0#二级满位发生退位[中层_0[T0, T1, T2, II0#Pred], 中层准备退位_0[T0, T1, T2, II0#Pred]]
  override type 前驱上一级操作[不退位 <: 三进制后继, 退位 <: 三进制后继]  = 不退位
  override type 二级满位发生退位[不退位 <: 三进制后继, 退位 <: 三进制后继] = 不退位
...
class 中层准备退位_0[T0, T1, T2, II0 <: 三进制后继] extends 三进制后继 {
  type _0_th = T0
  type _1_th = T1
  type _2_th = T2
  ...
  override type Next[T]                             = II0#后继上一级操作[中层_0[T0, T1, T2, II0#Next[T]], 中层准备进位_0[T0, T1, T2, II0#Next[T]]]
  override type 后继上一级操作[II <: 三进制后继, Need <: 三进制后继] = II
  override type Pred                                = 底层_2[T0, T1, T2]
  override type 前驱上一级操作[不退位 <: 三进制后继, 退位 <: 三进制后继]  = 不退位
  override type 二级满位发生退位[不退位 <: 三进制后继, 退位 <: 三进制后继] = 不退位
}
...
class 中层_1[T0, T1, T2, II0 <: 三进制后继, II1 <: 三进制后继] extends 三进制后继 {
  ...
  override type 后继上一级操作[II <: 三进制后继, Need <: 三进制后继] = II
  override type Pred                                = II0#二级满位发生退位[中层_1[T0, T1, T2, II0, II1#Pred], 中层准备退位_1[T0, T1, T2, II0, II1#Pred]]
  override type 前驱上一级操作[不退位 <: 三进制后继, 退位 <: 三进制后继]  = 不退位
  override type 二级满位发生退位[不退位 <: 三进制后继, 退位 <: 三进制后继] = 不退位
}
...
class 中层准备进位_1[T0, T1, T2, II0 <: 三进制后继, II1 <: 三进制后继] extends 三进制后继 {
  ...
  override type Next[T]                             = 中层满位_准备退位_2[T0, T1, T2, II0, II1, 底层_0[T]]
  override type 后继上一级操作[II <: 三进制后继, Need <: 三进制后继] = II
  override type Pred                                = II0#二级满位发生退位[中层_1[T0, T1, T2, II0, II1#Pred], 中层准备退位_1[T0, T1, T2, II0, II1#Pred]]
  override type 前驱上一级操作[不退位 <: 三进制后继, 退位 <: 三进制后继]  = 不退位
  override type 二级满位发生退位[不退位 <: 三进制后继, 退位 <: 三进制后继] = 不退位
...
class 中层准备退位_1[T0, T1, T2, II0 <: 三进制后继, II1 <: 三进制后继] extends 三进制后继 {
  type _0_th = T0
  type _1_th = T1
  type _2_th = T2
  ...
  override type Pred                                = 中层准备进位_0[T0, T1, T2, II0]
  override type 前驱上一级操作[不退位 <: 三进制后继, 退位 <: 三进制后继]  = 不退位
  override type 二级满位发生退位[不退位 <: 三进制后继, 退位 <: 三进制后继] = 不退位
}
...
class 中层满位_准备退位_2[T0, T1, T2, II0 <: 三进制后继, II1 <: 三进制后继, II2 <: 三进制后继] extends 三进制后继 {
  type _0_th = T0
  type _1_th = T1
  type _2_th = T2
  ...
  override type Next[T]                             = 中层满位_2[T0, T1, T2, II0, II1, II2#Next[T]]
  override type 后继上一级操作[不进位 <: 三进制后继, 进位 <: 三进制后继]  = 不进位
  override type Pred                                = 中层准备进位_1[T0, T1, T2, II0, II1]
  override type 前驱上一级操作[不退位 <: 三进制后继, 退位 <: 三进制后继]  = 不退位
  override type 二级满位发生退位[不退位 <: 三进制后继, 退位 <: 三进制后继] = 不退位
}
...
class 中层满位_2[T0, T1, T2, II0 <: 三进制后继, II1 <: 三进制后继, II2 <: 三进制后继] extends 三进制后继 {
  ...
  override type 前驱上一级操作[不退位 <: 三进制后继, 退位 <: 三进制后继]  = II2#前驱上一级操作[不退位, 退位]
  override type 二级满位发生退位[不退位 <: 三进制后继, 退位 <: 三进制后继] = 不退位
}
