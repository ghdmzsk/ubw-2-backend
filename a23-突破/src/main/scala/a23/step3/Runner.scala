...
object Runner {
  ...
  type 困难2  = 困难Positive[困难Positive[困难Positive[困难Positive[困难Positive[困难Positive[困难Positive[困难Positive[困难Zero, MM7], MM8], MM9], MM10], MM11], MM12], MM13], MM14]
  type 结果2 = 挑战者[挑战者[挑战者[
    挑战者[挑战者[挑战者[挑战者[挑战者[挑战者[挑战者[挑战者[挑战者[挑战者[挑战者[挑战者[挑战者[挑战者[挑战者基础3, Item1], MM7], Item2], MM8], Item3], MM9], Item1], MM10], Item2], MM11], Item3], MM12], Item4], MM13],
    Item5
  ], MM14], Item6]
  ...
  def main(arr: Array[String]): Unit = {
    ...
    val 困难2 = new 困难Positive(
      new 困难Positive(
        new 困难Positive(
          new 困难Positive(new 困难Positive(new 困难Positive(new 困难Positive(new 困难Positive(new 困难Zero, new MM7), new MM8), new MM9), new MM10), new MM11),
          new MM12
        ),
        new MM13
      ),
    ...
    /** ==========开始初始化==========
      ...
      * 获得胜利
      * 构成奖励
      * 结果2：挑战者(挑战者(挑战者(挑战者(挑战者(挑战者(挑战者(挑战者(挑战者(挑战者(挑战者(挑战者(挑战者(挑战者(挑战者(挑战者(挑战者(挑战者基础, Item1), MM7), Item2), MM8), Item3), MM9), Item1), MM10), Item2), MM11), Item3), MM12), Item4), MM13), Item5), MM14), Item6)
      */
