  ...
  def main(arr: Array[String]): Unit = {
    {
      ...
      val (number2, _) = number2gen(378)
      assert(count(number1.method1(number2)) == 28 * 378)
    }
    {
      val number1      = number1gen(238)
      val (_, number2) = number2gen(82)
      assert(count(number2.method2(number1)) == 238 * 82)
    }
  }
}
