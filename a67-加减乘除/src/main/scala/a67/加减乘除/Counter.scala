...
case class Number1S(tail: () => Number1) extends Number1 {
  override def method1(number1: Number1): Number2 = Number3S(() => tail().method1(number1))
}
...
case class Number1U(tail: () => Number1) extends Number1 {
  override def method1(number1: Number1): Number2 = Number3S(() => number1.method1(tail()))
}
...
trait Number2
case class Number3S(tail: () => Number2) extends Number2
