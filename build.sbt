...
val a09 = project in (file(".") / "a09-改变")
val a10 = project in (file(".") / "a10-自然数乘法")
val a11 = project in (file(".") / "a11-自然数提取")
val a12 = project in (file(".") / "a12-进制提取")
val a13 = project in (file(".") / "a13-加减乘除")
