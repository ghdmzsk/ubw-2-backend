...
trait Manwei_1_Q extends Qianjin {
  type M[II <: ItemCompare] = II#NN#Tail#G#_2#M[ItemCompareImpl[II#UU#Sub, II#UU, II#NN#Tail, II#CNN]]
  def qianjin[II <: ItemCompare](ii: II): II#NN#Tail#G#_2#M[ItemCompareImpl[II#UU#Sub, II#UU, II#NN#Tail, II#CNN]] = {
    println("1111" + ii.unPack)
    ii.jinzhi.tail.guishu._2
      .qianjin(new ItemCompareImpl(ii.unPack.sub, ii.unPack, ii.jinzhi.tail, ii.currentJinzhi))
  }
}
...
trait Manwei_0_Q extends Qianjin {
  type M[II <: ItemCompare] = II#NN#Tail#G#_1#M[ItemCompareImpl[II#UU#Sub, II#CUU, II#NN#Tail, II#NN]]
  def qianjin[II <: ItemCompare](ii: II): II#NN#Tail#G#_1#M[ItemCompareImpl[II#UU#Sub, II#CUU, II#NN#Tail, II#NN]] = {
    println("2222" + ii.unPack)
    ii.jinzhi.tail.guishu._1.qianjin(new ItemCompareImpl(ii.unPack.sub, ii.currentUnPack, ii.jinzhi.tail, ii.jinzhi))
  }
}
...
trait Kongwei_0_Q extends Qianjin {
  type M[II <: ItemCompare] = II#NN#Tail#G#_1#M[ItemCompareImpl[II#UU#Sub, II#CUU, II#NN#Tail, II#CNN]]
  def qianjin[II <: ItemCompare](ii: II): II#NN#Tail#G#_1#M[ItemCompareImpl[II#UU#Sub, II#CUU, II#NN#Tail, II#CNN]] = {
    println("4444" + ii.unPack)
    ii.jinzhi.tail.guishu._1
      .qianjin(new ItemCompareImpl(ii.unPack.sub, ii.currentUnPack, ii.jinzhi.tail, ii.currentJinzhi))
  }
}
...
trait UZero extends Qianjin {
  ...
  def qianjin[II <: ItemCompare](ii: II): II = {
    println("5555" + ii.jinzhi)
    println("55551111" + ii.currentJinzhi)
    ii
  }
}
